    ...
    OpenApiSpex.schema(%{
      ...
      properties: %{
        ...
        parent_impl_name: %OpenApiSpex.Schema{
          type: :string,
          description:
            "Name of a parent implementation for inheritance. When creating a new implementation, it will inherit tracked branches and refs from the parent (e.g., create 'feature-branch-impl' with parent 'main' to start with main's baseline). Useful for short-lived branches that extend an existing implementation"
        }
      },
      example: %{
