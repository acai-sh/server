defmodule AcaiWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AcaiWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AcaiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AcaiWeb.Gettext, "errors", msg, opts)
    end
  end
