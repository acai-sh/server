defmodule AcaiWeb.UserAuthTest do
  use AcaiWeb.ConnCase, async: true

  alias Acai.Accounts
  alias Acai.Accounts.Scope
  alias AcaiWeb.UserAuth

  import Acai.AccountsFixtures

  @remember_me_cookie "_acai_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, AcaiWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
